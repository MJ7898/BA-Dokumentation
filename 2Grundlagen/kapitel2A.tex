...
%Als Entdecker der Quaternionen gilt jedoch ein anderer –  –, einer der faszinierendsten Wissenschaftler des 
%19. Jahrhunderts. Be- reits in den frühen dreißiger Jahren beschäftigte er sich mit algebraischen Fra- gestellungen. So konnte Hamilton 
%1833 zeigen, dass die komplexen Zahlen eine Algebra bilden, falls die Einheiten 1 und i mit 12 = 1 und i2 = −1 benutzt wer- den. Alle 
%Elemente seiner Algebra haben dann die Form x + iy, wobei x, y reelle Zahlen sind.


%Auffassung hyperkomplexer Zahlen, abstammend von komplexen zahlen 
%Aufteilung in reelle und imaginäre Teile

%Formel schreiben 

%Brougham Bridge erläutern
\subsection{Rotation}
