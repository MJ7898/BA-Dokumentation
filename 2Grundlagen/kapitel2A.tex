...
Beobachtungen zu schätzen und gleichzeitig aus den gewonnenen Informationen eine Karte der Umgebung zu erstellen. \cite{slamdefi.2016a} 
...
können. \cite{stachniss.2017} %\cite{slamdefi.2016a} 
\begin{quote}
...
%Darunter sind taktile Sensoren, Näherungs-, Abstands-, Positionssensoren und visuelle Sensoren. Hinsichtlich Abstandssensoren, die 
...
%\\ 
%Bei Smartphones dient ausschließlich die Kamera zur Funktion des Mappings.
% werden diese Berechnungen ausschließlich mit der integrierten Kamera verwendet.
...
einer Algebra galten und werden daher als hyperkomplexe Zahlen aufgefasst. \cite{quaternionHamilton.2006}
\\ 
\linebreak
