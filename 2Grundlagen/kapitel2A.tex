...
Angenommen ein Roboter startet in einer Position auch Pose genannt und Konfiguration \textit{p0} und bewegt sich durch eine ihm 
unbekannte Umgebung, wobei diese nicht vorhandenen Kenntnisse das Hauptproblem darstellen. Die Einstellung beinhaltet Position und Ausrichtung 
...
Das Lösen des \acs{SLAM}-Problems wird in der Praxis mit den angestellten Verfahren, die sich bei der Anwendung durchsetzten, durchgeführt. In 
