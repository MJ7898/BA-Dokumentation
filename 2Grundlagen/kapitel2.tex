...
%   \end{tabular}
%   \caption{Merkmale der Computergrafik gegenüber der VR \cite{springer.2019s}}
%   \label{tbl:vrtabelle}
...
%, wobei bereits schon Erfolge erzielt werden konnten, die Entwicklung einer standhaften Plattform die nur darauf wartet, ausgebaut und intensiver genutzt zu werden.
...
nahezu exakte Information über Lage und Position nötig ist. %da in Relation zur realen Welt eine Abweichung um Zentimeter oder wenige Meter nicht von Belang ist.
%Bei Positionsbestimmungen auf kleinstem Raum ist eine 
...
deutlich mehr Komponenten benötigt und ist deutlich komplexer umzusetzen, als ein markerbasiertes System. 
\\ 
...
Der Benutzer ist nicht auf einen bestimmten Bezirk beschränkt und ist nicht auf die millimetergenaue Darstellung angewiesen.
\\ 
\linebreak
...
%So werden zusätzliche Recherchearbeiten oder Unklarheiten über Vorgänge aus dem Weg geräumt.
