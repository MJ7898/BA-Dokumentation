...
\\ 
\linebreak
Dies ist hier nur nebenbei erwähnt. Ich möchte mich an dieser Stelle ausschließlich dem industriellen Aspekt widmen und stelle andere 
...
des Tests stützte den Gedanken der Leistungsverbesserung und der Reduzierung des zeitlichen Aufwands, somit ließ dieses Resultat den %%%%<---!!!!Ändern!!-->
Anlass zu das vorliegende Ergebnis auf die Gesamtheit zu projizieren und für alle Anwendungsfälle allgemeingültig zu machen. Auf Basis der 
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=5cm,height=5cm,keepaspectratio]{2Grundlagen/Bilder/snapchatAR.jpeg}
...
Möglichkeit des alltäglichen Gebrauchs geboten, da diese im Vergleich zum Vorgängermodell deutlich komfortabler, leichter und 
