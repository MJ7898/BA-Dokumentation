...
Dieses Abschnitt befasst sich mit den wichtigsten Programmier-Technologien, die in diesem Projekt eingesetzt werden. Ein kurzer Überblick 
...
Kamerabild, sogenannte Merkmalspunkte (feature points). Anhand dieser Punkte wird die Änderung des Standortes berechnet. Durch Trägheitsmessungen 
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=15cm,height=7.5cm,keepaspectratio]{2Grundlagen/Bilder/motionTracking.png}
