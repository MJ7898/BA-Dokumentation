...
\\
Grundlegend ist das Model-View-Controller-Muster, MVC, für die klare Abgrenzung zwischen dem Datenmodell, der Darstellung der Daten und der Steuerung von 
Nutzerinteraktionen. Der Controller koordiniert die Aktionen der View und dem Model. Dieser fungiert als Verbindungsstück zwischen den Bestandteilen und informiert 
...
\begin{itemize}
    ...
    und grafisch als auch textuell dargestellt. Die Darstellung basiert auf einem \ac{ERM}, dass die Objekte (Entities) mit ihren jeweiligen 
...
Informationsverlust zu erleiden. Die Normalisierung wird in mehrere Stufen unterteil:
\begin{itemize}
