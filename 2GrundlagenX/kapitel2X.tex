...
mehrere kleine Teile, die als Module, Komponenten oder Bausteine beschrieben werden. Verschiedene Teile können bei geeigneter Funktion 
...
eine stabile und leistungsfähige Applikation zu designen. \cite{aac.2020j} Diese basiert auf bewährten Prinzipien, unter anderem dem \textit{seperation of concerns} Prinzip.
\\ 
\linebreak
...
synchronisieren zu können. \cite{viewModelAndroid.2020} Das Repository dient als Schnittstelle zu mehreren Datenbeziehungspunkten und verwaltet ein Verzeichnis zur 
...
\\ 
Die Normalisierung wird in mehrere Stufen unterteilt:
\begin{itemize}
...
entscheidend ist und oft ausreicht. \cite{normalisierung.2020j}
\\ 
