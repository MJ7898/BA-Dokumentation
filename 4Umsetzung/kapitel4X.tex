...
\end{figure} 
\\ 
Mit der soeben erläuterten Benutzeroberfläche geht folgender Programmablauf einher.
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=10cm,height=9cm,keepaspectratio]{4Umsetzung/Bilder/visualPAP.png}
...
\end{figure}
\\
Um für den Prototypen eine möglichst realitätsnahe Anwendung zu simulieren, wurde mithilfe eines Threads eine Statusänderung eines zufälligen Objekts eingebaut. 
\begin{figure}[hbt!]
    \centering
