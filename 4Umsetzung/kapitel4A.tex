...
\begin{figure}[hbt!]
    \centering
    \subfigure[Marker-Scan]{\includegraphics[width=7cm,height=7cm,keepaspectratio]{4Umsetzung//Bilder/scan_image.jpg}}
    \subfigure[Umgebungsberechnung]{\includegraphics[width=7cm,height=7cm,keepaspectratio]{4Umsetzung/Bilder/scan_environment.jpg}}
