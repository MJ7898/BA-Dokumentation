...
ausmachen. 
\\ 
Die Use Cases und deren Implementierung wurden nach logischer und chronologischer Reihenfolge entwickelt und dokumentiert. Diese feststehende Reihenfolge 
...
welche aufbauend auf die Scan-Phase funktioniert. Bei erstem Gebrauch der Anwendung ist eine vorzeitige Nutzung der Visualisierungs-Phase ohne weiteres 
nicht möglich, da zuvor ein Scan durchgeführt werden muss, der Daten generiert und diese zur Verfügung stellt.
\\ 
\linebreak 
Aufgeteilt wurden die Use Cases jeweils immer nach Frontend und Backend, demnach wird auch die Dokumentation in diesem Stil geschildert. 
\\ 
\linebreak
...
Android-Applikation geeignet, ausschließlich für Hardware die das Android Betriebssystem nutzt. 
\\
...
Build-Management-Automatisierungs-Tool stellt Android Studio das Tool Gradle zur Verfügung, welches die zu bauenden Projekte beschreibt. Hier werden unter 
...
Darüber hinaus wird dort auch die Version des ARCore Frameworks und des Sceneform \acs{SDK}s verwaltet, welches ebenso Bestandteile der Applikation sind.
\\ 
...
das Projekt navigiert werden und alle Klassen ähnlicher Eigenschaft befinden sich im selben Zielordner. Nachdem nun alle Vorbereitungen abgeschlossen 
