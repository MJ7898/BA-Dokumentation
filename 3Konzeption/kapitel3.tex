...
Bei der Konzeption wird darauf Rücksicht genommen, die Anwendung möglichst so zu planen, dass der Einsatzort nicht maßgeblich ist. 
...
über den gesamten Bildschirm erstrecken und sei zusätzlich mit weiteren zwei Buttons zu versehen. Diese werden in weiterem Verlauf 
...
SQLite Datenbank abgefragt und als Basis für das neue Objekt gesendet. So können die vorhandenen Marker visuell dargestellt werden. Die 
