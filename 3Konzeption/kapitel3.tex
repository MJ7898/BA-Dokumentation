...
Die Definition, der Aufgabe, der Scan-Phase ist entscheidend für die Konzeption und Umsetzung der Architektur- und Softwarekonzeption. 
...
Mittels Smartphone-Kamera hat der Nutzer die Möglichkeit die Umgebung zu scannen. Dabei wird am Anfang der Startpunkt als Nullpunkt, bzw. 
als Urpsrungskoordinaten des erstellten Koordinatensystems des Raums, festgelegt. Der Nutzer kann sich frei in dem Raum bewegen und ist 
durch das Smartphone nur mit den Händen etwas eingeschränkt. Während der Aufnahme wird anhand der im Smartphone integrierten Kamera und 
...
einem dreidimensionalen Koordinatensystem widergespiegelt, um Position, Blickrichtung und Höhe des zu erstellenden Objekts festzuhalten. 
So kommt das \acl{SLAM} Verfahren (siehe Abschnitt \ref{chap:SLAM}) zum Einsatz, welches das Smartphone genauestens räumlich lokalisiert und 
...
virtuelle Karte des Raums erstellt wird. Dadurch kann das Gerät die Realität wiedergeben. Anhand der selbst erzeugten Informationen, die durch
