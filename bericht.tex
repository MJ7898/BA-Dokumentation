...
\begin{abstract}
  ...
  Kombination aus Realität und Virtualität, bietet dem Benutzer eine neue Art der Realitätswahrnehmung.  
  \\ 
  \linebreak
  Diese Bachelorarbeit befasst sich mit der Konzeption und Umsetzung eines Assistenzsystems unter Verwendung der Augmented Reality Technologie. Dabei soll die Umgebung 
  ...
  Durch die entstehende Visualisierung können Informationen zu den jeweiligen Objekten eingetragen und angezeigt werden, dadurch kann das Überwachen von 
  Industriemaschinen vereinfacht werden. 
  \\ 
  Zu dem Konzept gehört die Ausarbeitung der grundlegenden Softwarearchitektur als auch ein allgemein-gültiges Datenmodell zur 
...
\begin{abstract}
  ...
  \\
  \linebreak
  This bachelor thesis deals with the conception and implementation of an assistance system using augmented reality technology. The environment %should
  ...
  The resulting visualization enables information on the respective objects to be entered and displayed, which enables monitoring of
  Industrial machines are simplified.
  \\
